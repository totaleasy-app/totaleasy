...
CREATE TABLE IF NOT EXISTS origem_configuracao_processo_eleitoral (
    ...
    nome_abreviado                            CHAR(3)     NOT NULL,
...
CREATE TABLE IF NOT EXISTS processo_eleitoral (
    ...
    id_origem_configuracao_processo_eleitoral INT         NOT NULL,
...
CREATE TABLE IF NOT EXISTS abrangencia (
    id_abrangencia INT         NOT NULL GENERATED ALWAYS AS IDENTITY,
    nome           VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS eleicao (
    ...
    FOREIGN KEY (id_abrangencia) REFERENCES abrangencia (id_abrangencia),
...
CREATE TABLE IF NOT EXISTS genero (
    ...
    cod_tse_genero INT         NOT NULL,
    nome           VARCHAR(31) NOT NULL,

    PRIMARY KEY (id_genero),
    UNIQUE      (cod_tse_genero),
    UNIQUE      (nome)
);


CREATE TABLE IF NOT EXISTS cor_raca (
    id_cor_raca      INT         NOT NULL GENERATED ALWAYS AS IDENTITY,
    cod_tse_cor_raca INT         NOT NULL,
    nome             VARCHAR(31) NOT NULL,

    PRIMARY KEY (id_cor_raca),
    UNIQUE      (cod_tse_cor_raca),
    UNIQUE      (nome)
);


CREATE TABLE IF NOT EXISTS grau_instrucao (
    id_grau_instrucao      INT         NOT NULL GENERATED ALWAYS AS IDENTITY,
    cod_tse_grau_instrucao INT         NOT NULL,
    nome                   VARCHAR(31) NOT NULL,

    PRIMARY KEY (id_grau_instrucao),
    UNIQUE      (cod_tse_grau_instrucao),
    UNIQUE      (nome)
);


CREATE TABLE IF NOT EXISTS estado_civil (
    id_estado_civil      INT         NOT NULL GENERATED ALWAYS AS IDENTITY,
    cod_tse_estado_civil INT         NOT NULL,
    nome                 VARCHAR(31) NOT NULL,

    PRIMARY KEY (id_estado_civil),
    UNIQUE      (cod_tse_estado_civil),
    UNIQUE      (nome)
);


CREATE TABLE IF NOT EXISTS ocupacao (
    id_ocupacao      INT          NOT NULL GENERATED ALWAYS AS IDENTITY,
    cod_tse_ocupacao INT          NOT NULL,
    nome             VARCHAR(127) NOT NULL,

    PRIMARY KEY (id_ocupacao),
    UNIQUE      (cod_tse_ocupacao),
    UNIQUE      (nome)
);
...
CREATE TABLE IF NOT EXISTS candidato (
    ...
    nome_completo        VARCHAR(63)     NULL,
    nome_urna            VARCHAR(63)     NULL,
    nome_social          VARCHAR(63)     NULL,
    num_cpf              CHAR(11)        NULL,
    num_titulo_eleitoral CHAR(12)        NULL,
    ...
    FOREIGN KEY (id_cor_raca)       REFERENCES cor_raca (id_cor_raca),
    FOREIGN KEY (id_grau_instrucao) REFERENCES grau_instrucao (id_grau_instrucao),
    FOREIGN KEY (id_estado_civil)   REFERENCES estado_civil (id_estado_civil),
    FOREIGN KEY (id_ocupacao)       REFERENCES ocupacao (id_ocupacao),
...
CREATE TABLE IF NOT EXISTS unidade_eleitoral (
    id_unidade_eleitoral INT NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_uf                INT     NULL,
    id_municipio         INT     NULL,

    PRIMARY KEY (id_unidade_eleitoral),
    FOREIGN KEY (id_uf)        REFERENCES uf (id_uf),
    FOREIGN KEY (id_municipio) REFERENCES municipio (id_municipio),
    UNIQUE      (id_uf),
    UNIQUE      (id_municipio),
    CHECK ((id_uf IS NOT NULL AND id_municipio IS NULL) OR (id_uf IS NULL AND id_municipio IS NOT NULL))
);
